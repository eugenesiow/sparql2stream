...
getQuery().addNamedGraphURI(iri) ;
  ...
  final public void StreamClause() throws ParseException {String iri ;
    jj_consume_token(STREAM);
    iri = SourceSelector();
    StreamParamsClause(iri);
  }

  final public void StreamParamsClause(String iri) throws ParseException {
...
RangeClause(iri);
  ...
  final public void RangeClause(String iri) throws ParseException {Token i; Token t;
